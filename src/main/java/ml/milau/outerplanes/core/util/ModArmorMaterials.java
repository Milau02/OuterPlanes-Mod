...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    JEWERLY("jewelry",7,new int[]{1,1,1,1},0,SoundEvents.ARMOR_EQUIP_GENERIC,0.0F,-0.2F,()->{
        return Ingredient.of(ModItems.GARNET.get());
    });
    ...
    public String getName() {return OuterPlanes.MOD_ID + ":" + this.name;}
